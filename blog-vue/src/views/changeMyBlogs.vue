...
<!--              <i class="el-icon-arrow-down el-icon-picture"></i>-->
          ...
          <div class="ui right aligned container">
            ...
            <button type="button" id="publish-btn" class="ui my-blue button" @click="add_Or_Update_Blog">更新</button>
          </div>
...
export default {
  ...
  methods: {
    ...
    handleEditorImgAdd (pos, $file) {
      ...
      this.$http.post('/file', formData).then(res => {
        if (res.data.flag) {
    ...
    add_Or_Update_Blog () {
      ...
      this.$refs.addForm.validate((valid) => {
        if (valid) {
         ...
         if(sessionStorage.getItem('my_blogid'))
         {  
      ...
      this.$axios.get(`/blog/admin/${sessionStorage.getItem('my_blogid')}`).then(res=>{
