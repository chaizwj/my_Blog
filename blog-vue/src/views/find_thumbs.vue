...
<!--    <div  class="m-container-small m-padded-tb-big">-->
      ...
      <div class="ui container">
        ...
        <el-table size="middle" current-row-key="id" :data="dataList" stripe highlight-current-row>
          ...
          <el-table-column prop="thumbs1.createtime" label="点赞时间" align="center"></el-table-column>
        
          <el-table-column prop="title" label="点赞的博客" align="center"></el-table-column>
...
// 分页查询  获取所有 点赞过的   博客
     ...
     this.$axios.get('/user/find_thumbs/'+this.pagination.currentPage+'/'+this.pagination.pageSize+'/'+window.sessionStorage.getItem('uid')).then(res=>{
